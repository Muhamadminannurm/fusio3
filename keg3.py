...
data_int = list(filter(lambda x: isinstance(x, int) and not isinstance(x, bool), random_list))  # Memperbaiki pemisahan nilai int
...
print("Data Int Mapped:", data_int_mapped)
